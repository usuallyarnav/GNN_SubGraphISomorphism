...
************************************************************
.SUBCKT AO22D0BWP A1 A2 B1 B2 Z VDD VSS 
MI23 net29 A2 VSS VSS nmos w=0.155u l=0.04u
MI16 net26 B1 net20 VSS nmos w=0.155u l=0.04u
MI22 net20 B2 VSS VSS nmos w=0.155u l=0.04u
MI24 net26 A1 net29 VSS nmos w=0.155u l=0.04u
MI8-M_u2 Z net26 VSS VSS nmos w=0.155u l=0.04u
MI8-M_u3 Z net26 VDD VDD pmos w=0.205u l=0.04u
MI20 net26 A1 net40 VDD pmos w=0.205u l=0.04u
MI19 net26 A2 net40 VDD pmos w=0.205u l=0.04u
M_u2 net40 B2 VDD VDD pmos w=0.205u l=0.04u
MI21 net40 B1 VDD VDD pmos w=0.205u l=0.04u
.ENDS
************************************************************
...
************************************************************
.SUBCKT AOI222D0BWP A1 A2 B1 B2 C1 C2 ZN VDD VSS 
MI21-M_u10 ZN C1 XI21-net17 VSS nmos w=0.155u l=0.04u
MI21-M_u11 XI21-net17 C2 VSS VSS nmos w=0.155u l=0.04u
MI6-M_u10 ZN A1 XI6-net17 VSS nmos w=0.155u l=0.04u
MI6-M_u11 XI6-net17 A2 VSS VSS nmos w=0.155u l=0.04u
MI20-M_u10 ZN B1 XI20-net17 VSS nmos w=0.155u l=0.04u
MI20-M_u11 XI20-net17 B2 VSS VSS nmos w=0.155u l=0.04u
MI15 VDD C1 net22 VDD pmos w=0.205u l=0.04u
MU27 VDD C2 net22 VDD pmos w=0.205u l=0.04u
MI19 net16 A1 ZN VDD pmos w=0.205u l=0.04u
MI18 net16 A2 ZN VDD pmos w=0.205u l=0.04u
MI17 net22 B1 net16 VDD pmos w=0.205u l=0.04u
MI16 net22 B2 net16 VDD pmos w=0.205u l=0.04u
.ENDS
************************************************************
...
************************************************************
.SUBCKT CKND1BWP I ZN VDD VSS 
M_u2 ZN I VSS VSS nmos w=0.27u l=0.04u
M_u1 ZN I VDD VDD pmos w=0.41u l=0.04u
.ENDS
************************************************************
...
************************************************************
.SUBCKT CKXOR2D1BWP A1 A2 Z VDD VSS 
M_u6-M_u3 net4 net10 net14 VSS nmos w=0.22u l=0.04u
MI0-M_u3 net6 A1 net14 VSS nmos w=0.155u l=0.04u
M_u2-M_u2 net4 A2 VSS VSS nmos w=0.31u l=0.04u
M_u5-M_u2 net6 net4 VSS VSS nmos w=0.155u l=0.04u
M_u4-M_u2 Z net14 VSS VSS nmos w=0.31u l=0.04u
M_u8-M_u2 net10 A1 VSS VSS nmos w=0.155u l=0.04u
M_u6-M_u2 net4 A1 net14 VDD pmos w=0.26u l=0.04u
MI0-M_u2 net6 net10 net14 VDD pmos w=0.205u l=0.04u
M_u2-M_u3 net4 A2 VDD VDD pmos w=0.41u l=0.04u
M_u5-M_u3 net6 net4 VDD VDD pmos w=0.205u l=0.04u
M_u4-M_u3 Z net14 VDD VDD pmos w=0.41u l=0.04u
...
************************************************************
.SUBCKT IND4D1BWP A1 B1 B2 B3 ZN VDD VSS 
MI13-M_u2 net020 A1 VSS VSS nmos w=0.155u l=0.04u
MI10 p2 net020 VSS VSS nmos w=0.31u l=0.04u
MI8 p0 B2 p1 VSS nmos w=0.31u l=0.04u
MI9 p1 B1 p2 VSS nmos w=0.31u l=0.04u
MU53 ZN B3 p0 VSS nmos w=0.31u l=0.04u
MI13-M_u3 net020 A1 VDD VDD pmos w=0.205u l=0.04u
MI18 ZN net020 VDD VDD pmos w=0.41u l=0.04u
MI5 ZN B1 VDD VDD pmos w=0.41u l=0.04u
MI6 ZN B2 VDD VDD pmos w=0.41u l=0.04u
MI7 ZN B3 VDD VDD pmos w=0.41u l=0.04u
.ENDS
************************************************************
...
************************************************************
.SUBCKT INR2D1BWP A1 B1 ZN VDD VSS 
MU1-M_u4 ZN B1 VSS VSS nmos w=0.31u l=0.04u
MU1-M_u3 ZN net4 VSS VSS nmos w=0.31u l=0.04u
MU6-M_u2 net4 A1 VSS VSS nmos w=0.155u l=0.04u
MU1-M_u1 XU1-net8 net4 VDD VDD pmos w=0.41u l=0.04u
MU1-M_u2 ZN B1 XU1-net8 VDD pmos w=0.41u l=0.04u
MU6-M_u3 net4 A1 VDD VDD pmos w=0.205u l=0.04u
.ENDS
************************************************************
...
************************************************************
.SUBCKT NR2D3BWP A1 A2 ZN VDD VSS 
MI27 net11 A2 VDD VDD pmos w=1.23u l=0.04u
MI28 ZN A1 net11 VDD pmos w=1.23u l=0.04u
MI6 ZN A2 VSS VSS nmos w=0.93u l=0.04u
MI5 ZN A1 VSS VSS nmos w=0.93u l=0.04u
.ENDS
************************************************************
...
************************************************************
.SUBCKT TIEHBWP Z VDD VSS 
M_u2 net6 net6 VSS VSS nmos w=0.31u l=0.04u
M_u1 Z net6 VDD VDD pmos w=0.41u l=0.04u
.ENDS
************************************************************

************************************************************
.SUBCKT TIELBWP ZN VDD VSS 
M_u2 ZN net6 VSS VSS nmos w=0.31u l=0.04u
M_u1 net6 net6 VDD VDD pmos w=0.41u l=0.04u
.ENDS
************************************************************
